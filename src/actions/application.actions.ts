      ...
      .insert([
        {
          ...
          current_semester: validatedData.currentSemester,
          degree: validatedData.degree,
          branch: validatedData.branch,
          expected_graduation_year: validatedData.expectedGraduationYear,
          current_skills: validatedData.currentSkills,
          ...
          preferred_domain: validatedData.preferredDomain,
          preferred_start_date: validatedData.preferredStartDate,
          available_hours: validatedData.availableHours,
          preferred_duration: validatedData.preferredDuration,
          career_goals: validatedData.careerGoals,

    ...
    <div className="min-h-screen flex flex-col bg-white dark:bg-[#0a0a0a]">
      ...
      <main className="flex-1 py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <h1 className="text-4xl md:text-5xl font-bold text-brand-900 dark:text-white mb-6">About InterNexa Labs</h1>
          <div className="prose prose-lg dark:prose-invert max-w-none">
            <p className="text-xl text-gray-600 dark:text-gray-300 mb-8">
              At InterNexa Labs, we believe that practical experience should not be a luxury. We are building an AI-powered EdTech platform that bridges the gap between theoretical knowledge and real-world skills by connecting ambitious students with high-impact internships at top tech companies.
            </p>

      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 lg:gap-8 mb-16">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="flex items-center gap-4">
              <a href="https://twitter.com/internexa" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white dark:bg-brand-900 flex items-center justify-center text-brand-500 hover:text-accent-600 dark:hover:text-accent-400 border border-brand-200 dark:border-brand-800 transition-colors">
                <TwitterIcon className="w-4 h-4" />
              </a>
              <a href="https://linkedin.com/company/internexa" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white dark:bg-brand-900 flex items-center justify-center text-brand-500 hover:text-accent-600 dark:hover:text-accent-400 border border-brand-200 dark:border-brand-800 transition-colors">
                <LinkedinIcon className="w-4 h-4" />
              </a>
              <a href="https://instagram.com/internexa" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white dark:bg-brand-900 flex items-center justify-center text-brand-500 hover:text-accent-600 dark:hover:text-accent-400 border border-brand-200 dark:border-brand-800 transition-colors">
                <InstagramIcon className="w-4 h-4" />
              </a>
              <a href="https://github.com/internexa" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-white dark:bg-brand-900 flex items-center justify-center text-brand-500 hover:text-accent-600 dark:hover:text-accent-400 border border-brand-200 dark:border-brand-800 transition-colors">
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm">
              ...
              <li><Link href="/support" className="text-brand-500 hover:text-brand-900 dark:hover:text-white transition-colors">Support</Link></li>
        ...
        <div className="border-t border-brand-200 dark:border-brand-900 pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-brand-500 text-sm">
            © {new Date().getFullYear()} InterNexa. All rights reserved.
          </p>
